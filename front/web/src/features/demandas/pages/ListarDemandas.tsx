...
import CustomTable from '../../../components/ui/Table'; // Importando o seu componente visual limpo
...
const dummyData: DemandaListResponse[] = [
  {
    id: 101,
    descricaoDemanda:
      'Um consumidor processa uma loja de eletrodomésticos após comprar uma geladeira que veio com defeito e nunca foi trocada, pedindo o dinheiro de volta (dano material) e uma compensação pela frustração e desgaste (dano moral).',
    prazo: '2026-09-15',
  ...
  },
  {
    id: 102,
    descricaoDemanda:
      'Um ex-funcionário processa a empresa onde trabalhava porque fazia duas horas a mais por dia e nunca recebeu o pagamento referente às horas extras, além de não ter recebido as verbas rescisórias corretas ao ser demitido.',
    prazo: '2026-09-18',

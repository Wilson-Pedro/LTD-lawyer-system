...
import CadastrarDemanda from './features/demandas/pages/CadastrarDemanda';
import CadastrarProcesso from './features/processos/pages/CadastrarProcesso';
import CadastrarAuth from './features/auth/pages/CadastrarAuth';
